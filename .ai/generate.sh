...
# ----------------------------------------------------------------------------
# Note: If lib/yaml-parser.sh is sourced, these functions are overridden
# with more robust implementations that use yq when available.
# The functions below serve as fallbacks for compatibility.
# ----------------------------------------------------------------------------

# Extract a simple value from YAML (handles basic cases)
# Prefer using yaml-parser.sh for complex YAML
yaml_get() {
    local file="$1"
    local key="$2"
